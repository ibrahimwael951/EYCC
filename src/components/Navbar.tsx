      ...
      <AnimatePresence>
        {isMenuOpened && (
          <motion.div
            ...
            className="fixed top-0 pt-20 p-5 w-full -z-10 md:hidden"
          >
            <div className="absolute top-0 left-0 w-full h-full bg-neutral-900/10 backdrop-blur-xl  -z-20" />
            <div className="flex flex-col gap-4">
              {navData.map((item) => (
                <Link key={item.title} href={item.href} className="flex items-center gap-2 text-2xl">
