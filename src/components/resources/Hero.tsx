    ...
    <section className="min-h-screen flex flex-col-reverse justify-center md:items-center md:flex-row gap-5 md:justify-between  ">
      <div className="md:w-2/4">
        <motion.h1
          {...FadeLeft}
          {...ViewPort}
          className="text-5xl flex font-semibold items-center gap-1 mb-5 "
        >
          <Database size={50} className="text-green-600" />
          Resources
        </motion.h1>
        <motion.p {...FadeLeft} {...ViewPort} className="text-lg ml-7">
          This challenge is built for learners. Whether you’ve never touched a
          terminal or you just learned what CTF means yesterday — you can start
